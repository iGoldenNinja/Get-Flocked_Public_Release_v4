...
Version note: Added grouped GPS/OSM geofencing, separate blue GEO alerts, and lower-panel GPS camera map. Public release ships empty geofence templates.
